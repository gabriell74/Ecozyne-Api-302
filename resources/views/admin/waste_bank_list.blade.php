        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">{{ $waste_bank_total }} Akun Bank Sampah Terdaftar</p>
                </div>
            </div>
            ...
            @if($waste_banks->isEmpty())
                <div class="alert alert-info text-center shadow-sm border-0 rounded-3">
                    Belum ada akun bank sampah yang terdaftar
                </div>
            @else <!-- Card List Bank Sampah -->
