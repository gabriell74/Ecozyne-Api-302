                ...
                <div class="card-body p-0">
                    ...
                    <div class="border-bottom border-dark p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="fw-bold mb-1">Bank Sampah Eco</h6>
                                <p class="text-muted mb-0">hBanksampah@gmail.com</p>
                    ...
                    <div class="border-bottom border-dark p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="fw-bold mb-1">Bank Eco Warriors</h6>
                    ...
                    <div class="border-bottom border-dark p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="fw-bold mb-1">Bank Bumi Sehat</h6>
                    ...
                    <div class="p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="fw-bold mb-1">Bank Community</h6>
                                <p class="text-muted mb-0">bankunity@gmail.com</p>
