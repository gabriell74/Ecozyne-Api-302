...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
        <h4 class="fw-bold mb-2" style="color:#2B3A55;">Daftar Artikel</h4>
        <a href="{{ route('article.create') }}" class="btn text-white rounded-3 px-4 py-2"
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                    <div class="card h-100 shadow-sm border-0 rounded-4 position-relative hover-card" 
                        ...
                        <form action="{{ route('article.destroy', $article->id)}}" 
                              ...
                              method="post" style="z-index: 10;" id="delete_form{{ $article->id }}">
                            @csrf @method('delete')
                            <button class="btn btn-sm btn-danger rounded-circle shadow-sm" type="button" onclick="confirmDelete('delete_form{{ $article->id }}')">
