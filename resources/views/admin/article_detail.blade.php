            ...
            <div class="col-12 col-md-6">
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="d-flex mb-4 border-bottom pb-3">
                        ...
                        <form action="{{ route('article.destroy', $article->id)}}" method="post" id="delete_form{{ $article->id }}">
                            @csrf @method('delete')
                            <button class="btn btn-outline-danger rounded-pill px-4" type="button" onclick="confirmDelete('delete_form{{ $article->id }}')">
