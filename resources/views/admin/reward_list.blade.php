                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                    <div class="card h-100 shadow-sm border-0 rounded-4 position-relative hover-card" 
                        ...
                        <form action="{{ route('reward.destroy', $reward->id)}}" 
                              ...
                              method="post" style="z-index: 10;" id="delete_form{{ $reward->id }}">
                            @csrf @method('delete')
                            <button class="btn btn-sm btn-danger rounded-circle shadow-sm" type="button" onclick="confirmDelete('delete_form{{ $reward->id }}')">
